  ...
  return (
    <div className='h-full w-[12vw] p-1 bg-[#0D2C32] flex flex-col'>
      ...
      <div className='flex-1 flex flex-col gap-4 pt-[3vh]'>
        ...
        <Link to={'/page1'}><div className={`w-full p-2 text-slate-300 text-lg rounded-lg flex items-center justify-center cursor-pointer ${activePage === '3' ? 'bg-[#7A7A7A]' : ''}`} id='3' onClick={(e)=>{setActivePage(e.target.id)}}>My services</div></Link>
