      ...
      <div className='flex-[3_3_0%] flex flex-col'>
        <div className='flex-[1_1_0%] flex px-10 py-4 items-end'>
          <div className='w-full'>
            ...
            <p className='text-slate-300 w-3/4 p-2 text-xl'>Connections? Mentors? Helpers? Seniors? Anything else?.. <span className='text-slate-200 text-2xl font-serif'> We have it!</span></p>
          </div>
        </div>
        <div className='flex-[3_3_0%] px-10 z-10'>
