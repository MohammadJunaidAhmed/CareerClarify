  ...
  return (
    <div className={`w-full ${isSearchBarVisible ? '' : 'invisible'}`}>
        <div className={`flex flex-col justify-center items-center pb-1`}>
          <form className={`flex-1 w-full bg-white h-10 rounded-md flex ${isClick?' outline outline-orange-400':''}`} onSubmit={handleSubmit}>
            <input type="search" list="queries"
             ...
             />
            <button className="w-10 bg-yellow-300 h-10 ml-auto rounded-e-md flex justify-center items-center hover:fill-orange-500" type="submit">
