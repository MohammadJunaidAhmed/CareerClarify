...
const NavBar = () => {
  ...
  return (
    <div className="w-screen bg-[#1d3362] font-bold border-b-2 border-black sticky top-0 z-50 pt-1">
      <div className={`w-full h-full flex ${scW < 540 ? 'flex-col':''}`}>
        ...
        {/* SEARCH BAR */}
        <div className={`flex-[4_4_0%] flex justify-center items-center pb-1`}>
