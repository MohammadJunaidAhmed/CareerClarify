...
const Account = () => {
  ...
  return (
    <div className={`w-12 h-12 rounded-full duration-300 ${isAccountOverLayComponentVisible?'bg-green-500 cursor-pointer w-20':'bg-white'}`} 
      onMouseOver={()=>{handleMouseEnter()}} 
      onMouseOut={()=>{handleMouseLeave();}}
    >
      <div className={`w-full h-full flex items-center duration-300 ${isAccountOverLayComponentVisible?' justify-center':'justify-center'} ${isMouseOnAccountOverLay?'':''}`}>
